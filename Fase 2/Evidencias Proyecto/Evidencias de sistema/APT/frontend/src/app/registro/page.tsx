...
export default function RegistroPage() {
  ...
  const [tipoUsuario, setTipoUsuario] = useState<'empresa' | 'candidato'>('candidato');
  ...
  const handleSubmitCandidato = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/candidatos`, {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
      ...
      <div className="max-w-2xl mx-auto">
        <div className="bg-white rounded-2xl shadow-xl p-8">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600 mt-2">Únete a nuestra plataforma de reclutamiento</p>
          </div>
            ...
            <form onSubmit={handleSubmitCandidato} className="space-y-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => setCandidatoForm({ ...candidatoForm, correo: e.target.value })}
                    className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    onChange={(e) => setCandidatoForm({ ...candidatoForm, contrasena: e.target.value })}
                    className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                    placeholder="••••••••"
                  />
                  <button
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) => setCandidatoForm({ ...candidatoForm, linkedinUrl: e.target.value })}
                  className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) => setCandidatoForm({ ...candidatoForm, experienciaAnios: parseInt(e.target.value) || 0 })}
                  className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                  placeholder="3"
                />
              </div>
          ...
          {tipoUsuario === 'empresa' && (
            <form onSubmit={handleSubmitEmpresa} className="space-y-4">
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    onChange={(e) => setEmpresaForm({ ...empresaForm, contrasena: e.target.value })}
                    className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                    placeholder="••••••••"
                  />
                  <button
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-2">Logo URL (opcional)</label>
                <input
                  type="url"
